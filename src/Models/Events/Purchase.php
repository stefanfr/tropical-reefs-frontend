...
use HappyHorizon\GA\MeasurementProtocol\Contracts\Models\Events\PurchaseContract;
...
class Purchase extends AbstractEventModel implements PurchaseContract
{
    protected static string $eventName = 'purchase';
