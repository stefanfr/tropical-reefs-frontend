...
use HappyHorizon\GA\MeasurementProtocol\Contracts\Models\Events\ViewItemContract;
...
class ViewItem extends AbstractEventModel implements ViewItemContract
{
    protected static string $eventName = 'view_item';
