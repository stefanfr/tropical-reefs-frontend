...
use HappyHorizon\GA\MeasurementProtocol\Contracts\Models\Events\AddToCartContract;
...
class AddToCart extends AbstractEventModel implements AddToCartContract
{
    protected static string $eventName = 'add_to_cart';
